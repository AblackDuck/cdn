...
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to gdi.js.org.
...
*   **Website** refers to gdi.js.org, accessible from [https://gdi.js.org](https://gdi.js.org)
...
The data is in your hands, as an open source project after generation, code of yours, we do not handle any data. User can control their own data.
...
*   By email: admin@hashhackers.com